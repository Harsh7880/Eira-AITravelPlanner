...
const About = () => {
  return (
    <div className="lg:my-10 lg:mt-32 my-8 lg:px-24 grid grid-cols-12 gap-3">
      <div className="lg:col-span-6 col-span-12 pt-5 lg:items-start items-center">
        <h2 className="mb-6 lg:text-5xl text-3xl px-4 lg:px-0   font-bold text-[#002c6a]">
          {ABOUT_TEXT.title}
        </h2>
      ...
      <div className="lg:col-span-6 col-span-12 items-center justify-center mt-10">
        <img className="w-[80%] lg:h-[400px] object-cover rounded-2xl mx-auto" src={about} alt="" />
      </div>
    </div>
  );
};
